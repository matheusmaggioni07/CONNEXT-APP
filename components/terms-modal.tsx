    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-card border border-border rounded-2xl max-w-lg w-full p-6 shadow-2xl">
        <div className="text-center mb-6">
          <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-primary to-pink-500 flex items-center justify-center">
            <Shield className="w-8 h-8 text-white" />
          </div>
          <h2 className="text-2xl font-bold text-foreground">Bem-vindo ao Connext!</h2>
        ...
        <div className="space-y-3 mb-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Regras de utilização da plataforma</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Uso de cookies no site</p>
            </div>
          </Link>
        </div>
